...
let setFruits = {
  ...
  startFruits: reverseLevelUp ? [9, 8, 7, 7, 6] : [0, 0, 1, 2, 2, 3],
  // startFruits: reverseLevelUp ? [1] : [9],
  randomFunction: () => {
...
let adLink = 'https://www.youtube.com/channel/UCmMs_sVY5peMzGLQvCOfL5Q';

// 修改网页标题：将 "合成大西瓜" 进行替换
document.getElementsByTagName("title")[0].innerText = 'マサオゲーム';
